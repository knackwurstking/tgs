...
type ReplyParameters struct {
	...
	ChatID int `json:"chat_id"` // [Optional] If the message to be replied to is from a different chat, unique identifier for the chat or username of the channel (in the format @channelusername). Not supported for messages sent on behalf of a business account.
	...
	QuotePosition            int             `json:"quote_position"`              // [Optional] Position of the quote in the original message in UTF-16 code units
}
